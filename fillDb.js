...
Course.insertMany([
    { name: 'JavaScript For Beginner', description:JavaScriptForBeginner,  category: categories[0], instructor:'Sridevi Malasani',length:'6h10mm',level:'Beginner',cover:'/public/assets/images/course/programming.png', price: 44.99  },
    { name: 'Java From Scratch',description:JavaFromScratch,  category: categories[0], instructor:'Michael Yang',length:'9h30mm',level:'Intermediate',cover:'/public/assets/images/course/programming.png', price: 55.99},
    { name: 'Introduction to OOP in Java',description:IntroductionToOOPInJava,  category: categories[0],instructor:'Joseph Lerman',length:'7h30mm',level:'Beginner',cover:'/public/assets/images/course/programming.png', price: 36.99},
    { name: 'Fullstack Web Developer',description:FullstackWebDeveloper,  category: categories[0], instructor:'Sridevi Malasani',length:'13h40mm',level:'Advanced',cover:'/public/assets/images/course/programming.png', price: 90.99},
    { name: 'Server Side Programming in Nodejs',description:ServerSideProgrammingInNodejs,  category: categories[0], instructor:'Sridevi Malasani',length:'5h40mm',level:'Intermediate',cover:'/public/assets/images/course/programming.png', price: 45.99},
    { name: 'Introduction To MySql',description:IntroductionToMySql,  category: categories[2], instructor:'Tacettin Umur Inan',length:'3h30mm',level:'Intermediate',cover:'/public/assets/images/course/db.png', price: 41.99},
    { name: 'Photoshop For Photographer',description:PhotoshopForPhotographer,  category: categories[1], instructor:'John Wesley Jean Baptiste',length:'4h39mm',level:'Intermediate',cover:'/public/assets/images/course/graphic.jpg', price: 49.99},
    { name: 'How to create a logo with Illustrator',description:HowToCreateALogoWithIllustrator,  category: categories[1], instructor:'Louinord Innocent',length:'8h30mm',level:'Intermediate',cover:'/public/assets/images/course/graphic.jpg', price: 53.99},
    { name: 'Photoshop MasterClass',description:PhotoshopMasterClass,  category: categories[1], instructor:'Louinord Innocent',length:'9h30mm',level:'Intermediate',cover:'/public/assets/images/course/graphic.jpg', price: 89.99},
    { name: 'Canva For Freelancer',description:CanvaForFreelancer,  category: categories[1], instructor:'John Wesley Jean Baptiste',length:'3h30mm',level:'Intermediate',cover:'/public/assets/images/course/graphic.jpg', price: 45.99},
    { name: 'Become A Graphic Designer With CorelDraw',description:BecomeAGraphicDesignerWithCorelDraw,  category: categories[1], instructor:'Quelo Sossou',length:'4h30mm',level:'Intermediate',cover:'/public/assets/images/course/graphic.jpg', price: 54.99},
    { name: 'Introduction To MongoDB',description:IntroductionToMongoDB,  category: categories[2], instructor:'Sridevi Malasani',length:'4h30mm',level:'Intermediate',cover:'/public/assets/images/course/db.png', price: 45.99},
    { name: 'Oracle Database For DBA',description:OracleDatabaseForDBA,  category: categories[2], instructor:'Harald Jean Pierre',length:'12h30mm',level:'Advenced',cover:'/public/assets/images/course/db.png', price: 89.99},
    { name: 'Mobile Development With React Native',description:MobileDevelopmentWithReactNative,  category: categories[0], instructor:'Robelkend Francois',length:'7h30mm',level:'Intermediate',cover:'/public/assets/images/course/programming.png', price: 45.99},
    { name: 'Front End Development With Angular',description:FrontEndDevelopmentWithAngular,  category: categories[0], instructor:'Muhyieddin Khaled',length:'5h30mm',level:'Beginner',cover:'/public/assets/images/course/programming.png', price: 45.99},
